...
//TODO: Centralizar em uma classe todas as caracteristicas visuais do aplicativo, como padrao de padding, cores etc
void main() {
...
class ListTileCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      child: ListTile(
        title: Text(news[index].title, style: TextStyle(fontFamily: 'Roboto')),
        subtitle: Text(
          news[index].content,
